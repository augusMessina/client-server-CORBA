...
public class _ServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements ChatApp.ServerInterface
{
  ...
  public String createNewPrivateRooms (String roomName, String password)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createNewPrivateRooms", true);
                $out.write_string (roomName);
                $out.write_string (password);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                ...
                return createNewPrivateRooms (roomName, password        );
            } finally {
                _releaseReply ($in);
            }
  } // createNewPrivateRooms
  ...
  public String joinPrivateRoom (String roomToJoin, String password, String name)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("joinPrivateRoom", true);
                $out.write_string (roomToJoin);
                $out.write_string (password);
                $out.write_string (name);
                $in = _invoke ($out);
                ...
                return joinPrivateRoom (roomToJoin, password, name        );
            } finally {
                _releaseReply ($in);
            }
  } // joinPrivateRoom
